        ...
        >
          ...
          >
            ...
            >
              ...
              >
                {totals.income.toLocaleString()} د.ك
              </p>
            </div>
            <div
              style={{
            ...
            >
              ...
              >
                {totals.expense.toLocaleString()} د.ك
              </p>
            </div>
            <div
              style={{
            ...
            >
              ...
              >
                {custodyTotal.toLocaleString()} د.ك
              </p>
            </div>
            <div
              style={{
                padding: "15px",
                backgroundColor: profitLoss >= 0 ? "#EFF6FF" : "#FFF7ED",
                borderRadius: "12px",
                border: profitLoss >= 0 ? "#DBEAFE" : "#FFEDD5",
              }}
            >
              <p
                style={{
                  fontSize: "12px",
                  color: profitLoss >= 0 ? "#1E40AF" : "#9A3412",
                  marginBottom: "5px",
                }}
              >
                صافي الربح/الخسارة
              ...
              <p
                style={{
                  fontSize: "18px",
                  fontWeight: "bold",
                  color: profitLoss >= 0 ? "#1D4ED8" : "#C2410C",
                }}
              >
                {profitLoss.toLocaleString()} د.ك
              </p>
            </div>
          </div>
