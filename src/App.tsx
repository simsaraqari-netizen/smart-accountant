        ...
        >
          ...
          <form onSubmit={handleEmailAuth} className="space-y-4 text-right">
            ...
            <button
              ...
              disabled={authLoading}
              className="w-full bg-white text-gray-700 py-2 rounded-lg font-black text-sm hover:bg-gray-50 transition-all active:scale-[0.98] border border-gray-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
